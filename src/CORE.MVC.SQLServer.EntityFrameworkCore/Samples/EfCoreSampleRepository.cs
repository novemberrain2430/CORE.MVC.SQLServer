...
{
    public class EfCoreSampleRepository : EfCoreRepository<SQLServerDbContext, Sample, Guid>, ISampleRepository
    {
        public EfCoreSampleRepository(IDbContextProvider<SQLServerDbContext> dbContextProvider)
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? SampleConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<Sample> ApplyFilter(
            IQueryable<Sample> query,
            string filterText,
            string name = null,
            DateTime? date1Min = null,
            DateTime? date1Max = null,

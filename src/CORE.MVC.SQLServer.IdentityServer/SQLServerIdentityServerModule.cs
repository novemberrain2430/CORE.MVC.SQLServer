...
namespace CORE.MVC.SQLServer
{
    ...
    public class SQLServerIdentityServerModule : AbpModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                Configure<AbpVirtualFileSystemOptions>(options =>
                {
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<SQLServerDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}CORE.MVC.SQLServer.Domain", Path.DirectorySeparatorChar)));
                });
            }

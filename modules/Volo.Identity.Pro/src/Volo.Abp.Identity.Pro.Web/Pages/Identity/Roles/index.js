                ...
                [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            if (row.isDefault) {
                                name += '<span class="badge badge-pill ml-1 badge-success">' + l('DisplayName:IsDefault') + '</span>';
                            }

                            if (row.isPublic) {
                                name += '<span class="badge badge-pill ml-1 badge-info">' + l('DisplayName:IsPublic') + '</span>';
                            }

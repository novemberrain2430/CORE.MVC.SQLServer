...
namespace Volo.Abp.Identity
{
    public class IdentityUserStore_Tests : AbpIdentityDomainTestBase
    {
        ...
        [Fact]
        public void IdentityUserStore_Should_Be_Replaced_By_IdentityProUserStore()
        {
            GetRequiredService<IdentityUserStore>().GetType().ShouldBe(typeof(IdentityProUserStore));
            GetRequiredService<IUserStore<IdentityUser>>().GetType().ShouldBe(typeof(IdentityProUserStore));
        }

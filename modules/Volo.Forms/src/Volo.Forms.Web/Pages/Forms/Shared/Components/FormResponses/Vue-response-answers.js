                ...
                <div class="container">
                        ...
                        <div v-if="value.questionType===3">                            
                            ...
                            <div class="" v-for="(choice, index) in orderedChoices">
                                <div class="custom-control custom-radio">                          
                                    ...
                                    <label class="custom-control-label" v-bind:for="choice.id">
                                        <div v-if="isOtherField(choice) && currentAnswer.value===otherChoice" class="form-inline" style="margin-top:-.5rem; display: block">
                                            <span>Other:</span>         
                                            <input type="text" disabled v-bind:id="choice.id" 
                                                v-model="otherValue"
                                                class="form-control"
                                                style="margin-left:1rem; min-width: 400px">
                                            </validation-provider>    
                                        </div>
                        ...
                        <div v-if="value.questionType===4">                            
                            ...
                            <small class="form-text text-muted">{{value.description}}</small>
                                ...
                                <div class="choice" v-for="(choice, index) in orderedChoices">                        
                                <div class="custom-control custom-checkbox">
                                    <input disabled type="checkbox" v-bind:id="choice.id" tabindex="-1" 
                                        v-bind:value="choice"                            
                                        v-model="currentAnswer.selectedAnswers" 
                                        aria-describedby="desc" class="custom-control-input">  
                                    <label class="custom-control-label" v-bind:for="choice.id">                                        
                                        <div v-if="isOtherField(choice) && isOtherCheckboxSelected()" class="form-inline" style="margin-top:-.5rem; display: block">
                                            <span>Other:</span>                                                                     
                        ...
                        <div class="form-group ">
                            ...
                            <select disabled class="custom-select" v-model="currentAnswer.value">

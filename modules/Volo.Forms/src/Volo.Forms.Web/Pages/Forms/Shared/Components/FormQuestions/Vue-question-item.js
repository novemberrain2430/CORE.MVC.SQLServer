        ...
        <div class="card question" :id="value.id">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <div class="custom-control custom-switch" style="padding-top: 0.5em">
                          <input v-model="value.isRequired" v-on:change="debouncedQuestionUpdate" type="checkbox" class="custom-control-input" v-bind:id="'switch_'+value.id">
                          <label class="custom-control-label" v-bind:for="'switch_'+value.id">{{l("Form:Questions:Required")}}</label>
                        </div>
                    </div>

...
namespace Volo.Forms.Forms
{
    ...
    public class FormApplicationService : FormsAppServiceBase, IFormApplicationService
    {
        ...
        public async Task<PagedResultDto<FormDto>> GetListAsync(GetFormListInputDto input)
        {
        ...
        {
            var result = await FormRepository.GetWithQuestionsAsync(id, includeChoices: true);
